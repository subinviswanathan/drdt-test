...
<header class="header">
    <div class="content-wrapper">
        ...
        <div class="pure-u-1-2 newsletter-signup-header mobile-hide">
            <a class="subscribe-header" target="_blank" rel="noopener"
               href="https://www.constructionprotips.com/newsletters/">
                <img class="subscribe-logo initial loaded" alt="Subscribe"
                     src="http://cpt.test.rda.net/wp-content/uploads/sites/9/2018/10/cpt-newsletter-header.png"
    ...
    <nav class="main-navigation">
        <div class="pure-menu pure-menu-horizontal">
            ...
            <div class="search-form mobile-hide">
                <form class="pure-form" action=" <?php echo site_url() ?>/search/index ">
                    <fieldset>
...
<div class="pure-g newsletter-sign-below-header hide-on-mobile">
    <div class="pure-u-sm-1 pure-u-md-1 pure-u-lg-1 pure-u-xl-1 nl-signup-link text-center">
        <a href="#"><h4>Sign Up for Our Newsletters <img class="nl-right-arrow" src="<?= get_stylesheet_directory_uri(); ?>/images/chevron-right-solid.svg"/></h4></a>
    </div>
</div>
<!-- #site-navigation -->
