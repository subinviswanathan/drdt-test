...
<header class="header">
	...
	<div class="content-wrapper">
		...
		<a data-analytics-metrics='{"link_name":"home logo","link_module":"header","link_pos":"secondary navigation"}' href="/" class="pure-u-2-5 logo">
...
<div class="pure-g newsletter-sign-below-header hide-on-mobile">
	<div class="pure-u-sm-1 pure-u-md-1 pure-u-lg-1 pure-u-xl-1 nl-signup-link">
		<a data-analytics-metrics='{"link_name":"<?php echo esc_url( get_theme_mod( 'bumblebee_banner_url' ) ); ?>","link_module":"header","link_pos":"internal promotion"}' href="<?php echo esc_url( get_theme_mod( 'bumblebee_banner_url' ) ); ?>">
