...
<header class="header">
	...
	<div class="content-wrapper">
		...
		<a href="/" class="pure-u-1-5 logo">
			<img src="<?php echo echo esc_html( get_theme_mod( 'bumblebee_header_logo' ) ); ?>" alt="" style="width:<?php echo echo esc_html( get_theme_mod( 'bumblebee_header_logo_width' ) ); ?>px"></img>
		</a>
