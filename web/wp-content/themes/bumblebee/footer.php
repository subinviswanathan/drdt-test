    ...
    <div class="container">
        <div class="pure-g">
            <div class="pure-u-1 desktop-hide-footer newsletter">
                ...
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/diyu-header-sticky.png"></img>
            </div>
        </div>
        ...
        <div class="pure-g">
                ...
                <div class="footer-left-top border-right">
                    <div class="pure-g">
                        <div class="pure-u-lg-5-12">
                            <div class="ipad-hide">
                                <a href=" <?php echo site_url(); ?> " class="footer-logo"></a>
								<?php
            ...
            <div class="pure-u-sm-5-12">
                <div class="newsletter">
                    ...
                    <form action="<?php echo get_site_url() ?>/newslettersignuppage/" method="post">
        ...
        <div class="pure-g">
            <div class="pure-u-sm-7-12">
                <div class="border-right">
					...
					?>
                    <div class="copyright">&copy; <?php echo $copyright_year; ?> <?php echo __( 'Home Service Publications, Inc', 'tmbi-theme-v3' ); ?></div>
                </div>
            </div>
            <div class="pure-u-5-12 newsletter-desktop mobile-hide-footer">
                <a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/diyu-header-sticky.png"></img></a>
            </div>
        </div>
    </div>
</footer>
