...
function bumblebee_scripts() {
	...
	wp_enqueue_script( 'bumblebee-navigation', get_template_directory_uri() . '/js/navigation-min.js', array(), '20151215', true );

	wp_enqueue_script( 'bumblebee-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix-min.js', array(), '20151215', true );
