...
class AdStack {
	...
	public function register_scripts() {
		wp_register_script( 'ad-stack', plugins_url() . '/ad-stack/js/ad-stack.js', [], '1.0.0', true );
	}
	 ...
	 */
	public function bumblebee_add_slot_name_prefix( $ad_options ) {
	 ...
	 */
	public function bumblebee_maybe_remove_ad_stack() {
	 ...
	 * @see query_vars
	 */
	public function bumblebee_add_variant_query_var( $vars ) {
		$vars[] .= 'variant';
		return $vars;
	}
}
